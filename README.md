...
###问题上传
    ...
    $ curl -u miguel:python -i -X POST -H "Content-Type: application/json" -d '{"comp_id":"1","user_id":"1","number":"3","content":"gggggggggggggggggggggg"}' http://api.chih.me/snail/api/v0.1/queses
注意：问题类型为`已存在`的公司类型
